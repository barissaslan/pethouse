...
class PetControllerTest {
    ...
    void getAllPetsShouldReturnSuccess() throws Exception {
        when(petService.findAll()).thenReturn(getDummyPetList());
    ...
    void addPetShouldReturnSuccess() throws Exception {
        when(petService.add(anyString(), any(), any())).thenReturn(getDummyPet());

        MvcResult result = mvc.perform(post(PET_CONTROLLER_URL)
                .content(asJsonString(getDummyAddPetRequest()))
